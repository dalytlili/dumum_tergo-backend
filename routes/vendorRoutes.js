...
router.post('/complete-profile', upload.single('image'), VerifyTokenvendor, completeProfile);
router.get('/logout', VerifyTokenvendor, logout)
router.get('/profile', VerifyTokenvendor, userProfile);
router.post('/update-profile', upload.single('image'), VerifyTokenvendor, updateProfile);
